...
class AlexNet(object):
    ...
    def create(self):
        ...
        with tf.variable_scope(self.name, 'AlexNet', [self.X, self.NUM_CLASSES]):
            conv1 = conv(self.X, 11, 11, 96, 4, 4, padding='VALID', name='conv1')
            norm1 = lrn(conv1, 2, 1.99999994948e-05, 0.75, name='norm1')
            pool1 = max_pool(norm1, 3, 3, 2, 2, padding='VALID', name='pool1')

            conv2 = conv(pool1, 5, 5, 256, 1, 1, group=2, name='conv2')
            norm2 = lrn(conv2, 2, 1.99999994948e-05, 0.75, name='norm2')
            ...
            self.fc_final = fc(drop6, self.NUM_CLASSES, relu=False, name='fc8')
