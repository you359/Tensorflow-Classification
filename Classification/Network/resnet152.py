...
class ResNet152(object):
    ...
    def create(self):
        ...
        with tf.variable_scope(self.name, 'ResNet-152', [self.X, self.NUM_CLASSES]):
            ...
            res3b4_branch2a = conv(res3b3_relu, 1, 1, 128, 1, 1, biased=False, relu=False, name='res3b4_branch2a')
            bn3b4_branch2a = batch_normalization(res3b4_branch2a, relu=True, name='bn3b4_branch2a')
            res3b4_branch2b = conv(bn3b4_branch2a, 3, 3, 128, 1, 1, biased=False, relu=False, name='res3b4_branch2b')
            bn3b4_branch2b = batch_normalization(res3b4_branch2b, relu=True, name='bn3b4_branch2b')
            res3b4_branch2c = conv(bn3b4_branch2b, 1, 1, 512, 1, 1, biased=False, relu=False, name='res3b4_branch2c')
            bn3b4_branch2c = batch_normalization(res3b4_branch2c, name='bn3b4_branch2c')

            res3b4 = add([res3b3_relu, bn3b4_branch2c], name='res3b4')
            res3b4_relu = relu(res3b4, name='res3b4_relu')
            res3b5_branch2a = conv(res3b4_relu, 1, 1, 128, 1, 1, biased=False, relu=False, name='res3b5_branch2a')
            bn3b5_branch2a = batch_normalization(res3b5_branch2a, relu=True, name='bn3b5_branch2a')
            res3b5_branch2b = conv(bn3b5_branch2a, 3, 3, 128, 1, 1, biased=False, relu=False, name='res3b5_branch2b')
            bn3b5_branch2b = batch_normalization(res3b5_branch2b, relu=True, name='bn3b5_branch2b')
            res3b5_branch2c = conv(bn3b5_branch2b, 1, 1, 512, 1, 1, biased=False, relu=False, name='res3b5_branch2c')
            bn3b5_branch2c = batch_normalization(res3b5_branch2c, name='bn3b5_branch2c')

            res3b5 = add([res3b4_relu, bn3b5_branch2c], name='res3b5')
            res3b5_relu = relu(res3b5, name='res3b5_relu')
            res3b6_branch2a = conv(res3b5_relu, 1, 1, 128, 1, 1, biased=False, relu=False, name='res3b6_branch2a')
            bn3b6_branch2a = batch_normalization(res3b6_branch2a, relu=True, name='bn3b6_branch2a')
            res3b6_branch2b = conv(bn3b6_branch2a, 3, 3, 128, 1, 1, biased=False, relu=False, name='res3b6_branch2b')
            bn3b6_branch2b = batch_normalization(res3b6_branch2b, relu=True, name='bn3b6_branch2b')
            res3b6_branch2c = conv(bn3b6_branch2b, 1, 1, 512, 1, 1, biased=False, relu=False, name='res3b6_branch2c')
            bn3b6_branch2c = batch_normalization(res3b6_branch2c, name='bn3b6_branch2c')

            res3b6 = add([res3b5_relu, bn3b6_branch2c], name='res3b6')
            res3b6_relu = relu(res3b6, name='res3b6_relu')
            res3b7_branch2a = conv(res3b6_relu, 1, 1, 128, 1, 1, biased=False, relu=False, name='res3b7_branch2a')
            bn3b7_branch2a = batch_normalization(res3b7_branch2a, relu=True, name='bn3b7_branch2a')
            res3b7_branch2b = conv(bn3b7_branch2a, 3, 3, 128, 1, 1, biased=False, relu=False, name='res3b7_branch2b')
            bn3b7_branch2b = batch_normalization(res3b7_branch2b, relu=True, name='bn3b7_branch2b')
            res3b7_branch2c = conv(bn3b7_branch2b, 1, 1, 512, 1, 1, biased=False, relu=False, name='res3b7_branch2c')
            bn3b7_branch2c = batch_normalization(res3b7_branch2c, name='bn3b7_branch2c')

            res3b7 = add([res3b6_relu, bn3b7_branch2c], name='res3b7')
            res3b7_relu = relu(res3b7, name='res3b7_relu')
            res4a_branch1 = conv(res3b7_relu, 1, 1, 1024, 2, 2, biased=False, relu=False, name='res4a_branch1')
            bn4a_branch1 = batch_normalization(res4a_branch1, name='bn4a_branch1')

            res4a_branch2a = conv(res3b7_relu, 1, 1, 256, 2, 2, biased=False, relu=False, name='res4a_branch2a')
            ...
            res4b23_branch2a = conv(res4b22_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b23_branch2a')
            bn4b23_branch2a = batch_normalization(res4b23_branch2a, relu=True, name='bn4b23_branch2a')
            res4b23_branch2b = conv(bn4b23_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b23_branch2b')
            bn4b23_branch2b = batch_normalization(res4b23_branch2b, relu=True, name='bn4b23_branch2b')
            res4b23_branch2c = conv(bn4b23_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b23_branch2c')
            bn4b23_branch2c = batch_normalization(res4b23_branch2c, name='bn4b23_branch2c')

            res4b23 = add([res4b22_relu, bn4b23_branch2c], name='res4b23')
            res4b23_relu = relu(res4b23, name='res4b23_relu')
            res4b24_branch2a = conv(res4b23_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b24_branch2a')
            bn4b24_branch2a = batch_normalization(res4b24_branch2a, relu=True, name='bn4b24_branch2a')
            res4b24_branch2b = conv(bn4b24_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b24_branch2b')
            bn4b24_branch2b = batch_normalization(res4b24_branch2b, relu=True, name='bn4b24_branch2b')
            res4b24_branch2c = conv(bn4b24_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b24_branch2c')
            bn4b24_branch2c = batch_normalization(res4b24_branch2c, name='bn4b24_branch2c')

            res4b24 = add([res4b23_relu, bn4b24_branch2c], name='res4b24')
            res4b24_relu = relu(res4b24, name='res4b24_relu')
            res4b25_branch2a = conv(res4b24_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b25_branch2a')
            bn4b25_branch2a = batch_normalization(res4b25_branch2a, relu=True, name='bn4b25_branch2a')
            res4b25_branch2b = conv(bn4b25_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b25_branch2b')
            bn4b25_branch2b = batch_normalization(res4b25_branch2b, relu=True, name='bn4b25_branch2b')
            res4b25_branch2c = conv(bn4b25_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b25_branch2c')
            bn4b25_branch2c = batch_normalization(res4b25_branch2c, name='bn4b25_branch2c')

            res4b25 = add([res4b24_relu, bn4b25_branch2c], name='res4b25')
            res4b25_relu = relu(res4b25, name='res4b25_relu')
            res4b26_branch2a = conv(res4b25_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b26_branch2a')
            bn4b26_branch2a = batch_normalization(res4b26_branch2a, relu=True, name='bn4b26_branch2a')
            res4b26_branch2b = conv(bn4b26_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b26_branch2b')
            bn4b26_branch2b = batch_normalization(res4b26_branch2b, relu=True, name='bn4b26_branch2b')
            res4b26_branch2c = conv(bn4b26_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b26_branch2c')
            bn4b26_branch2c = batch_normalization(res4b26_branch2c, name='bn4b26_branch2c')

            res4b26 = add([res4b25_relu, bn4b26_branch2c], name='res4b26')
            res4b26_relu = relu(res4b26, name='res4b26_relu')
            res4b27_branch2a = conv(res4b26_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b27_branch2a')
            bn4b27_branch2a = batch_normalization(res4b27_branch2a, relu=True, name='bn4b27_branch2a')
            res4b27_branch2b = conv(bn4b27_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b27_branch2b')
            bn4b27_branch2b = batch_normalization(res4b27_branch2b, relu=True, name='bn4b27_branch2b')
            res4b27_branch2c = conv(bn4b27_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b27_branch2c')
            bn4b27_branch2c = batch_normalization(res4b27_branch2c, name='bn4b27_branch2c')

            res4b27 = add([res4b26_relu, bn4b27_branch2c], name='res4b27')
            res4b27_relu = relu(res4b27, name='res4b27_relu')
            res4b28_branch2a = conv(res4b27_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b28_branch2a')
            bn4b28_branch2a = batch_normalization(res4b28_branch2a, relu=True, name='bn4b28_branch2a')
            res4b28_branch2b = conv(bn4b28_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b28_branch2b')
            bn4b28_branch2b = batch_normalization(res4b28_branch2b, relu=True, name='bn4b28_branch2b')
            res4b28_branch2c = conv(bn4b28_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b28_branch2c')
            bn4b28_branch2c = batch_normalization(res4b28_branch2c, name='bn4b28_branch2c')

            res4b28 = add([res4b27_relu, bn4b28_branch2c], name='res4b28')
            res4b28_relu = relu(res4b28, name='res4b28_relu')
            res4b29_branch2a = conv(res4b28_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b29_branch2a')
            bn4b29_branch2a = batch_normalization(res4b29_branch2a, relu=True, name='bn4b29_branch2a')
            res4b29_branch2b = conv(bn4b29_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b29_branch2b')
            bn4b29_branch2b = batch_normalization(res4b29_branch2b, relu=True, name='bn4b29_branch2b')
            res4b29_branch2c = conv(bn4b29_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b29_branch2c')
            bn4b29_branch2c = batch_normalization(res4b29_branch2c, name='bn4b29_branch2c')

            res4b29 = add([res4b28_relu, bn4b29_branch2c], name='res4b29')
            res4b29_relu = relu(res4b29, name='res4b29_relu')
            res4b30_branch2a = conv(res4b29_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b30_branch2a')
            bn4b30_branch2a = batch_normalization(res4b30_branch2a, relu=True, name='bn4b30_branch2a')
            res4b30_branch2b = conv(bn4b30_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b30_branch2b')
            bn4b30_branch2b = batch_normalization(res4b30_branch2b, relu=True, name='bn4b30_branch2b')
            res4b30_branch2c = conv(bn4b30_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b30_branch2c')
            bn4b30_branch2c = batch_normalization(res4b30_branch2c, name='bn4b30_branch2c')

            res4b30 = add([res4b29_relu, bn4b30_branch2c], name='res4b30')
            res4b30_relu = relu(res4b30, name='res4b30_relu')
            res4b31_branch2a = conv(res4b30_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b31_branch2a')
            bn4b31_branch2a = batch_normalization(res4b31_branch2a, relu=True, name='bn4b31_branch2a')
            res4b31_branch2b = conv(bn4b31_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b31_branch2b')
            bn4b31_branch2b = batch_normalization(res4b31_branch2b, relu=True, name='bn4b31_branch2b')
            res4b31_branch2c = conv(bn4b31_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b31_branch2c')
            bn4b31_branch2c = batch_normalization(res4b31_branch2c, name='bn4b31_branch2c')

            res4b31 = add([res4b30_relu, bn4b31_branch2c], name='res4b31')
            res4b31_relu = relu(res4b31, name='res4b31_relu')
            res4b32_branch2a = conv(res4b31_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b32_branch2a')
            bn4b32_branch2a = batch_normalization(res4b32_branch2a, relu=True, name='bn4b32_branch2a')
            res4b32_branch2b = conv(bn4b32_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b32_branch2b')
            bn4b32_branch2b = batch_normalization(res4b32_branch2b, relu=True, name='bn4b32_branch2b')
            res4b32_branch2c = conv(bn4b32_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b32_branch2c')
            bn4b32_branch2c = batch_normalization(res4b32_branch2c, name='bn4b32_branch2c')

            res4b32 = add([res4b31_relu, bn4b32_branch2c], name='res4b32')
            res4b32_relu = relu(res4b32, name='res4b32_relu')
            res4b33_branch2a = conv(res4b32_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b33_branch2a')
            bn4b33_branch2a = batch_normalization(res4b33_branch2a, relu=True, name='bn4b33_branch2a')
            res4b33_branch2b = conv(bn4b33_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b33_branch2b')
            bn4b33_branch2b = batch_normalization(res4b33_branch2b, relu=True, name='bn4b33_branch2b')
            res4b33_branch2c = conv(bn4b33_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b33_branch2c')
            bn4b33_branch2c = batch_normalization(res4b33_branch2c, name='bn4b33_branch2c')

            res4b33 = add([res4b32_relu, bn4b33_branch2c], name='res4b33')
            res4b33_relu = relu(res4b33, name='res4b33_relu')
            res4b34_branch2a = conv(res4b33_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b34_branch2a')
            bn4b34_branch2a = batch_normalization(res4b34_branch2a, relu=True, name='bn4b34_branch2a')
            res4b34_branch2b = conv(bn4b34_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b34_branch2b')
            bn4b34_branch2b = batch_normalization(res4b34_branch2b, relu=True, name='bn4b34_branch2b')
            res4b34_branch2c = conv(bn4b34_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b34_branch2c')
            bn4b34_branch2c = batch_normalization(res4b34_branch2c, name='bn4b34_branch2c')

            res4b34 = add([res4b33_relu, bn4b34_branch2c], name='res4b34')
            res4b34_relu = relu(res4b34, name='res4b34_relu')
            res4b35_branch2a = conv(res4b34_relu, 1, 1, 256, 1, 1, biased=False, relu=False, name='res4b35_branch2a')
            bn4b35_branch2a = batch_normalization(res4b35_branch2a, relu=True, name='bn4b35_branch2a')
            res4b35_branch2b = conv(bn4b35_branch2a, 3, 3, 256, 1, 1, biased=False, relu=False, name='res4b35_branch2b')
            bn4b35_branch2b = batch_normalization(res4b35_branch2b, relu=True, name='bn4b35_branch2b')
            res4b35_branch2c = conv(bn4b35_branch2b, 1, 1, 1024, 1, 1, biased=False, relu=False, name='res4b35_branch2c')
            bn4b35_branch2c = batch_normalization(res4b35_branch2c, name='bn4b35_branch2c')

            res4b35 = add([res4b34_relu, bn4b35_branch2c], name='res4b35')
            res4b35_relu = relu(res4b35, name='res4b35_relu')
            res5a_branch1 = conv(res4b35_relu, 1, 1, 2048, 2, 2, biased=False, relu=False, name='res5a_branch1')
            bn5a_branch1 = batch_normalization(res5a_branch1, name='bn5a_branch1')

            res5a_branch2a = conv(res4b35_relu, 1, 1, 512, 2, 2, biased=False, relu=False, name='res5a_branch2a')
